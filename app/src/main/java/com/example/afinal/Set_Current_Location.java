...
public class Set_Current_Location extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set__current__location);
    ...
    public void onClick(View v)
    {
        if (v.getId() == R.id.btn_setLocation)
        {
            ...
            Post_Add_Stair_Dash Stair = new Post_Add_Stair_Dash();
